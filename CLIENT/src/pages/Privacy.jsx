      ...
      <section className="w-full flex flex-col gap-4">
        ...
        <div className="flex flex-col w-full">
          <p>
            ...
            <ul className="list-disc pl-5 mb-4">
              <li>
                Traités de manière licite, loyale et transparente au regard de
                la personne concernée (licéité, loyauté, transparence) ;
              </li>
              <li>
                Collectées pour finalités déterminées, explicites et légitimes,
                et ne pas être traitées ultérieurement d’une manière
      ...
      <section className="w-full flex flex-col gap-4">
        ...
        <p>
          ...
          <ul className="list-disc pl-5 mb-4">
            ...
            <li>
              A des acheteurs ou des acheteurs potentiels de cette société dans
              le cas où nous cherchons à la vendre
            </li>
          </ul>
